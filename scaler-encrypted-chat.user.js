...
(function () {
  ...
  async function initProfiles() {
    const saved = storageGet(STORAGE_KEY_PROFILES, null);
    ...
    activeProfileId = storageGet(STORAGE_KEY_ACTIVE, profiles[0]?.id || null);
  ...
  function saveProfiles() {
    storageSet(STORAGE_KEY_PROFILES, profiles);
    storageSet(STORAGE_KEY_ACTIVE, activeProfileId);
  }
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      /* Floating Dropdown attached directly to body */
  ...
  function injectNativeChatControls() {
    ...
    // 1. Inject Key Profile Pill into .chat-input__controls
    if (chatControls && !chatControls.querySelector('.scaler-enc-controls-wrapper')) {
      ...
      pill.addEventListener('click', (e) => {
        ...
        // Position accurately above or below pill
      ...
      // Target .chat-input__controls-right if exists, or append to chatControls
    ...
    // 2. Inject Lock Button inside .chat-input__field beside emoji
        ...
        <div class="scaler-enc-modal-header">
          <div class="scaler-enc-modal-title" style="display:flex; align-items:center; gap:8px;">
            <svg width="20" height="20" viewBox="0 0 512 512" fill="none" style="flex-shrink:0;">
              <defs>
                <linearGradient id="uShield" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stop-color="#0284c7"/>
                  <stop offset="50%" stop-color="#2563eb"/>
                  <stop offset="100%" stop-color="#7c3aed"/>
                </linearGradient>
                <linearGradient id="uLock" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stop-color="#ffffff"/>
                  <stop offset="100%" stop-color="#f1f5f9"/>
                </linearGradient>
                <linearGradient id="uCyan" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stop-color="#38bdf8"/>
                  <stop offset="100%" stop-color="#0284c7"/>
                </linearGradient>
              </defs>
              <path d="M 256,44 C 362,44 428,96 432,188 C 436,296 360,392 256,456 C 204,424 162,384 136,344 L 96,368 C 84,375 70,366 73,352 L 84,304 C 74,272 72,232 76,188 C 80,96 150,44 256,44 Z" fill="url(#uShield)"/>
              ...
              <rect x="172" y="196" width="168" height="136" rx="28" ry="28" fill="url(#uLock)"/>
              <circle cx="256" cy="248" r="18" fill="url(#uCyan)"/>
              <path d="M 248,252 L 264,252 L 268,284 C 268,288 264,292 260,292 L 252,292 C 248,292 244,288 244,284 Z" fill="url(#uCyan)"/>
            </svg>
